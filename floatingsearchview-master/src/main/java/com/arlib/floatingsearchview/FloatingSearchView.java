...
public class FloatingSearchView extends FrameLayout {
    ...
    private int mSuggestionsTextSizePx1;
    private int mSuggestionsTextSizePx2;
    ...
    public interface OnSearchListener {
         ...
         */
        void onSuggestionClicked(SearchResult searchSuggestion);
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            setSuggestionItemTextSize1(a.getDimensionPixelSize(
                    R.styleable.FloatingSearchView_floatingSearch_searchSuggestionTextSize1,
                    Util.spToPx(ATTRS_SUGGESTION_TEXT_SIZE_SP_DEFAULT)));
            setSuggestionItemTextSize2(a.getDimensionPixelSize(
                    R.styleable.FloatingSearchView_floatingSearch_searchSuggestionTextSize2,
                    Util.spToPx(ATTRS_SUGGESTION_TEXT_SIZE_SP_DEFAULT)));
     ...
     * @param sizePx
     */
    private void setSuggestionItemTextSize1(int sizePx) {
        //todo implement dynamic suggestionTextSize setter and expose method
        this.mSuggestionsTextSizePx1 = sizePx;
    }

    private void setSuggestionItemTextSize2(int sizePx) {
        //todo implement dynamic suggestionTextSize setter and expose method
        this.mSuggestionsTextSizePx2 = sizePx;
    }
    ...
    private void setupSuggestionSection() {
        ...
        mSuggestionsAdapter = new SearchSuggestionsAdapter(getContext(), mSuggestionsTextSizePx1, mSuggestionsTextSizePx2, new SearchSuggestionsAdapter.Listener() {

            @Override
            public void onItemSelected(SearchResult item) {
                if (mSearchListener != null) {
            ...
            @Override
            public void onMoveItemToSearchClicked(SearchResult item) {
                setQueryText(item.getText1());
            }
        });
        refreshShowMoveUpSuggestion();
     ...
     */
    public void swapSuggestions(final List<? extends SearchResult> newSearchSuggestions) {
        swapSuggestions(newSearchSuggestions, true);
    }

    private void swapSuggestions(final List<? extends SearchResult> newSearchSuggestions,
    ...
    private boolean updateSuggestionsSectionHeight(List<? extends SearchResult>
    ...
    private int calculateSuggestionItemsHeight(List<? extends SearchResult> suggestions, int max) {
    ...
    public void clearSuggestions() {
        swapSuggestions(new ArrayList<SearchResult>());
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.suggestionTextSize1 = mSuggestionsTextSizePx1;
        savedState.suggestionTextSize2 = mSuggestionsTextSizePx2;
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        setSuggestionItemTextSize1(savedState.suggestionTextSize1);
        setSuggestionItemTextSize2(savedState.suggestionTextSize2);
    ...
    static class SavedState extends BaseSavedState {
        ...
        private List<? extends SearchResult> suggestions = new ArrayList<>();
        private boolean isFocused;
        private String query;
        private int queryTextSize;
        private int suggestionTextSize1;
        private int suggestionTextSize2;
        ...
        private SavedState(Parcel in) {
            ...
            suggestionTextSize1 = in.readInt();
            suggestionTextSize2 = in.readInt();
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeInt(suggestionTextSize1);
            out.writeInt(suggestionTextSize2);
